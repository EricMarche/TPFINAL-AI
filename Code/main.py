...
rn_monks1.train(train_monks1, train_labels_monks1)
rn_monks2.train(train_monks2, train_labels_monks2)
rn_monks3.train(train_monks3, train_labels_monks3)
...
# rn_iris.test(train_iris, train_labels_iris)
# rn_congress.test(train_congress, train_labels_congress)
# rn_monks1.test(train_monks1, train_labels_monks1)
# rn_monks2.test(train_monks2, train_labels_monks2)
# rn_monks3.test(train_monks3, train_labels_monks3)
